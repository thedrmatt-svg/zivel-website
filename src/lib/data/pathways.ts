...
import skinHealthRegenerativeAesthetics from "@/content/pathways/skin-health-regenerative-aesthetics";
import travelResetJetLagRecovery from "@/content/pathways/travel-reset-jet-lag-recovery";
