...
export const metadata: Metadata = {
  title: "Thank You | Zivel × Salt Lake Bees",
...
const TEAM_ACCENT = "#f5c518";

export default function BeesThankYouPage() {
  return (
    <main
    ...
    >
      ...
      <div className="flex items-center justify-center gap-4 mb-10">
        ...
        {/* Replace with: <Image src="/images/ads/bees-logo.png" alt="Salt Lake Bees" ... /> */}
        <span
      ...
      <p className="text-white/65 leading-relaxed max-w-md mx-auto mb-3 text-[1.0625rem]">
        Thank you for claiming your exclusive Salt Lake Bees × Zivel offer.
