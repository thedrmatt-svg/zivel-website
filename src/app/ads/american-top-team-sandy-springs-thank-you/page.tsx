  ...
  return (
    <main className="min-h-screen bg-[#07101d] relative overflow-hidden flex items-center">
      ...
      <div className="ty-wrap ty-grid relative z-10 py-20">
        <div>
          <div className="flex items-center gap-3 mb-12"><Image src="/images/brand/zivel-logo.png" alt="Zivel" width={90} height={30} style={{ width: "auto", height: "auto" }} /><span className="text-white/25 text-2xl">×</span><Image src="/images/ads/american-top-team-logo.png" alt="American Top Team" width={52} height={52} style={{ width: "auto", height: "auto" }} /></div>
