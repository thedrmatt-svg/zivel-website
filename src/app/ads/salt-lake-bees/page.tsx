...
const PARTNER_LOCKUP = "SALT LAKE BEES × ZIVEL";
...
// Logo: drop /images/ads/bees-logo.png to replace the text placeholder
...
const VALUE_PROPS = [
  ...
  "Official Wellness Partner of the Salt Lake Bees",
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Team logo slot — replace div with next/image when /images/ads/bees-logo.png is available */}
      ...
      <main id="main-content" tabIndex={-1}>
        ...
        >
          ...
          <div
            ...
            style={{
              background: "linear-gradient(135deg, #1a1400 0%, #0d0a00 50%, #080600 100%)",
            }}
          >
            {/* Subtle team-color glow */}
            <div
              className="absolute inset-0 opacity-10"
              style={{ background: `radial-gradient(ellipse at 60% 40%, ${TEAM_ACCENT}, transparent 70%)` }}
              aria-hidden="true"
            />
            {/* Athlete image slot */}
            {/*
              ...
              <Image
                ...
                alt="Salt Lake Bees athlete recovery at Zivel"
                fill
            ...
            */}
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-4" aria-hidden="true">
              ...
              <code className="text-xs text-white/10">/images/ads/bees-athlete.jpg</code>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
              ...
              <div>
                ...
                <p className="text-white/65 leading-relaxed mb-8">
                  As an Official Wellness Partner of the Salt Lake Bees, Zivel is
              ...
              <div
                ...
                style={{ backgroundColor: "rgba(20,15,0,0.95)" }}
              >
                <div className="mb-5">
                  <span
