...
const PARTNER_LOCKUP = "Salt Lake Bees";
const TAGLINE = "WELLNESS. PERFORM. THRIVE.";
const SUPPORTING = "Premium wellness services trusted by athletes.";
const FOOTER_LINE = "OFFICIAL WELLNESS PARTNER OF THE SALT LAKE BEES";
const FOOTER_CTA = "FEEL BETTER. PERFORM BETTER.";
const THANK_YOU_URL = "/ads/salt-lake-bees-thank-you";
const SOURCE_LABEL = "Salt Lake Bees Google Ads";
const TEAM_ACCENT = "#f5c518"; // Bees yellow
const HERO_BG = "#090700";
const LOGO_PATH = "/images/ads/bees-logo.png";
...
export const metadata: Metadata = {
  title: "30% Off + $5 First Visit | Zivel × Salt Lake Bees Official Wellness Partner",
  description:
    "Exclusive offer for Salt Lake Bees fans — 30% off any service and your first visit for just $5. Cryotherapy, red light therapy, sauna, float, and more at Zivel Riverton.",
  robots: { index: false, follow: false },
};

// ── Page ──────────────────────────────────────────────────────────────────────
export default function SaltLakeBeesPage() {
  return (
    <>
      {/* ── Sticky minimal header ─────────────────────────────────────────── */}
      <header
        className="sticky top-0 z-50 border-b border-white/10"
        style={{ backgroundColor: "rgba(9,7,0,0.97)", backdropFilter: "blur(10px)" }}
      >
        <div className="max-w-7xl mx-auto px-5 sm:px-8 h-14 flex items-center justify-between gap-4">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-xs font-black tracking-[0.15em] uppercase" style={{ color: TEAM_ACCENT }}>
              {PARTNER_LOCKUP}
            </span>
          </div>
      ...
      <main id="main-content" tabIndex={-1}>
        ...
        {/* ── HERO ─────────────────────────────────────────────────────────── */}
        <section className="relative min-h-[92vh] overflow-hidden flex flex-col" style={{ backgroundColor: HERO_BG }}>
          ...
          <div
            ...
            style={{ background: `linear-gradient(to right, ${HERO_BG} 45%, ${HERO_BG}cc 60%, transparent 80%)` }}
            aria-hidden="true"
          />
          ...
          <div className="relative z-10 flex-1 flex flex-col max-w-7xl mx-auto w-full px-5 sm:px-10 lg:px-16">
            ...
            <div className="pt-8 sm:pt-10 flex flex-wrap items-center gap-3 sm:gap-5">
              ...
              <div className="ml-auto hidden sm:block">
                <span
                  className="px-3 py-1 text-xs font-black tracking-widest uppercase rounded-sm"
                  style={{ backgroundColor: TEAM_ACCENT, color: "#000" }}
                >
            ...
            <div className="flex-1 flex flex-col justify-center py-10 max-w-[580px]">
              ...
              <div className="flex items-center gap-3 mb-5">
                <span className="text-lg" style={{ color: TEAM_ACCENT }}>★</span>
              ...
              <p
                ...
                style={{ fontSize: "clamp(3.5rem, 9vw, 7rem)", color: TEAM_ACCENT, lineHeight: 0.85, fontFamily: "var(--font-inter)" }}
              >
                JUST $5
              </p>
        ...
        <section id="claim" className="scroll-mt-14" style={{ backgroundColor: "#f5f3ee" }}>
          <div className="max-w-7xl mx-auto px-5 sm:px-10 lg:px-16 py-16">
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-12 lg:gap-16 items-start">
              ...
              {/* Left: tagline + services + trust */}
              <div>
                <h2
                  className="text-3xl sm:text-4xl font-black text-gray-900 uppercase tracking-tight mb-2 leading-tight"
                >
                  {TAGLINE}
                </h2>
                ...
                <div className="grid grid-cols-5 gap-3 mb-12">
                  {SERVICES_ROW.map((s) => (
                    <div key={s.name} className="flex flex-col items-center text-center">
                      <div
                        className="w-12 h-12 rounded-xl mb-2 flex items-center justify-center text-2xl"
        ...
        {/* ── Footer ────────────────────────────────────────────────────────── */}
        <footer style={{ backgroundColor: "#0a0800" }}>
          ...
          <div className="border-t border-white/5">
            <div className="max-w-7xl mx-auto px-5 sm:px-10 lg:px-16 py-4 flex items-center justify-between">
              ...
              <a href="https://www.zivel.com/privacy-policy" className="text-xs text-white/20 underline underline-offset-2 hover:text-white/40 transition-colors">
                Privacy Policy
              </a>
            </div>
          </div>
