...
const PARTNER_LOCKUP = "REAL SALT LAKE × ZIVEL";
...
const MAROON = "#8b1a1a";
// Logo: drop /images/ads/rsl-logo.png to replace the text placeholder
...
const VALUE_PROPS = [
  ...
  "Official Wellness Partner of Real Salt Lake",
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Team logo slot — replace span with next/image when /images/ads/rsl-logo.png is available */}
      ...
      <main id="main-content" tabIndex={-1}>
        ...
        >
          ...
          <div
            ...
            style={{
              background: "linear-gradient(135deg, #1a0505 0%, #0d0202 50%, #060101 100%)",
            }}
          >
            {/* Maroon glow */}
            <div
              className="absolute inset-0 opacity-20"
              style={{ background: `radial-gradient(ellipse at 60% 40%, ${MAROON}, transparent 70%)` }}
              aria-hidden="true"
            />
            {/* Athlete image slot */}
            {/*
              ...
              <Image
                ...
                alt="Real Salt Lake athlete recovery at Zivel"
                fill
            ...
            */}
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-4" aria-hidden="true">
              ...
              <code className="text-xs text-white/10">/images/ads/rsl-athlete.jpg</code>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
              ...
              <div>
                ...
                <p className="text-white/65 leading-relaxed mb-8">
                  As an Official Wellness Partner of Real Salt Lake, Zivel is
