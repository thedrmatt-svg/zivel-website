...
const PARTNER_LOCKUP = "Utah Royals";
  ...
  return (
    <>
      ...
      <main id="main-content" tabIndex={-1}>
        ...
        {/* ── HERO ─────────────────────────────────────────────────────────── */}
        <section className="relative min-h-[92vh] overflow-hidden flex flex-col" style={{ backgroundColor: "#00030c" }}>
          ...
          <div
            ...
            style={{ background: `linear-gradient(to right, #00030c 45%, #00030ccc 60%, transparent 80%)` }}
            aria-hidden="true"
          />
        ...
        {/* ── Footer ────────────────────────────────────────────────────────── */}
        <footer style={{ backgroundColor: "#00030c" }}>
