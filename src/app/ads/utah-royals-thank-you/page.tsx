...
export const metadata: Metadata = {
  title: "Thank You | Zivel × Utah Royals",
...
export default function RoyalsThankYouPage() {
  return (
    <main
    ...
    >
      ...
      <div className="flex items-center justify-center gap-4 mb-10">
        ...
        {/* Replace with: <Image src="/images/ads/royals-logo.png" alt="Utah Royals" ... /> */}
        <span
      ...
      <p className="text-white/65 leading-relaxed max-w-md mx-auto mb-3 text-[1.0625rem]">
        Thank you for claiming your exclusive Utah Royals × Zivel offer.
