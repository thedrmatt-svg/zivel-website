    ...
    <main className="space-y-0">
      ...
      <div className="zv-bleed zv-section-light zv-light">
        <div className="px-6 py-5 border-b border-black/8">
          <p className="text-sm text-black/55 italic text-center max-w-lg mx-auto">
      ...
      {(() => {
        ...
        function ServiceCard({ s, i }: { s: typeof services[0]; i: number }) {
          ...
          const heroSrc = s.hero?.media?.type === "image" ? s.hero.media.src : null;

          return (
            <ScrollReveal key={s.slug} variant="fade-up" delay={i * 80}>
              <Link
                href={`/services/${s.slug}`}
                className="group relative overflow-hidden rounded-2xl border border-black/8 bg-white transition hover:-translate-y-1 hover:border-black/15"
        ...
        return (
          <section className="zv-bleed zv-section-light zv-light zv-noise py-16 space-y-20">
                  ...
                  <div key={group.label}>
                    <ScrollReveal variant="fade-up">
                      <div className="mb-10 flex items-center gap-4">
                        ...
                        <h2 className="font-serif text-2xl md:text-3xl font-light tracking-tight text-black/80 whitespace-nowrap">
                          {group.label}
                        </h2>
                        <div className="h-px flex-1 bg-black/10" />
                      </div>
