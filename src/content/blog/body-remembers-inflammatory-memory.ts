...
const blogPost: BlogPost = {
  slug: "body-remembers-inflammatory-memory",
  title: "The Body Remembers: New Research Confirms Lifelong Inflammatory Memory",
  description:
    "Groundbreaking research from Nature reveals that our stem cells hold a \"memory\" of inflammation. At Zivel, we've long understood that the body remembers — which is why consistent recovery practices are essential for long-term health.",
  ...
  content: [
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "What \"Inflammatory Memory\" Means for You"
    },
    {
      type: "paragraph",
      text:
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "How Zivel Helps Reduce Lifelong Inflammatory Burden"
    },
    {
      type: "paragraph",
      text:
