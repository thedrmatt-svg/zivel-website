...
const parker_co: Location = {
  ...
  seo: {
    title: "Cryotherapy, Red Light & Recovery in Parker, CO | Zivel",
    description:
      "Zivel Parker offers cryotherapy, red light therapy, dry float, infrared sauna, and recovery services in Parker, CO.",
    canonical: "/locations/colorado/parker",
  },

  hero: {
    headline: "Modern Wellness & Recovery in Parker, CO",
    subheadline:
      "Science-backed therapies designed to help you recover faster, feel better, and perform at your best.",
    image: "/images/locations/parker-co/hero.svg",
  },

  about: {
    headline: "Your Local Recovery Studio in Parker",
    body: [
      "Zivel Parker brings modern wellness technology and recovery services to the Parker community.",
      "Our studio combines cutting-edge technology with personalized care to support recovery, performance, and longevity.",
    ],
    image: "/images/locations/parker-co/about.svg",
  },
  ...
  owners: [
    {
      name: "Local Owner",
      bio: "Passionate wellness professional committed to serving the Parker community with advanced recovery and longevity services.",
    },
  ],
