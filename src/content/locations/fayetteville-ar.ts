...
const fayetteville_ar: Location = {
  ...
  seo: {
    title: "Cryotherapy, Red Light & Recovery in Fayetteville, AR | Zivel",
    description:
      "Zivel Fayetteville offers cryotherapy, red light therapy, dry float, infrared sauna, and recovery services in Fayetteville, AR.",
    canonical: "/locations/arkansas/fayetteville",
  },
  ...
  about: {
    headline: "Your Local Recovery Studio in Fayetteville",
    body: [
  ...
  owners: [
    {
      name: "Local Owner",
      bio: "Passionate wellness professional committed to serving the Fayetteville community with advanced recovery and longevity services.",
    },
  ],
...
export default fayetteville_ar;
