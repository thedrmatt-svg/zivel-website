...
export const zivel_metairie_location: Location = {
  ...
  pricing: {
    ...
    standardPrices: [
      ...
      { name: "Compression Therapy", price: "$35", note: "Single session" },
      { name: "Oxygen Bar", price: "$35", note: "Single session" },
      { name: "Cryo Slimming", price: "$350", note: "Single session" },
      { name: "Cryo Toning", price: "$300", note: "Single session" },
      { name: "CryoLift Facial", price: "$200", note: "Single session" },
      { name: "Cryo Soothe", price: "$100", note: "Single session" },
    ],
  },
