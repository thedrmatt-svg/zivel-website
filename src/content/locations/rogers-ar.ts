...
const rogers_ar: Location = {
  ...
  seo: {
    title: "Cryotherapy, Red Light & Recovery in Rogers, AR | Zivel",
    description:
      "Zivel Rogers offers cryotherapy, red light therapy, dry float, infrared sauna, and recovery services in Rogers, AR.",
    canonical: "/locations/arkansas/rogers",
  },

  hero: {
    headline: "Modern Wellness & Recovery in Rogers, AR",
    subheadline:
      "Science-backed therapies designed to help you recover faster, feel better, and perform at your best.",
    image: "/images/locations/rogers-ar/hero.svg",
  },

  about: {
    headline: "Your Local Recovery Studio in Rogers",
    body: [
      "Zivel Rogers brings modern wellness technology and recovery services to the Rogers community.",
      "Our studio combines cutting-edge technology with personalized care to support recovery, performance, and longevity.",
    ],
    image: "/images/locations/rogers-ar/about.svg",
  },
  ...
  owners: [
    {
      name: "Local Owner",
      bio: "Passionate wellness professional committed to serving the Rogers community with advanced recovery and longevity services.",
    },
  ],
