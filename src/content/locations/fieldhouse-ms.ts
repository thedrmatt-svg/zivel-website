...
const fieldhouse_ms: Location = {
  ...
  seo: {
    title: "Cryotherapy, Red Light & Recovery in Fieldhouse, MS | Zivel",
    description:
      "Zivel Fieldhouse offers cryotherapy, red light therapy, dry float, infrared sauna, and recovery services in Fieldhouse, MS.",
    canonical: "/locations/mississippi/fieldhouse",
  },

  hero: {
    headline: "Modern Wellness & Recovery in Fieldhouse, MS",
    subheadline:
      "Science-backed therapies designed to help you recover faster, feel better, and perform at your best.",
    image: "/images/locations/fieldhouse-ms/hero.svg",
  },

  about: {
    headline: "Your Local Recovery Studio in Fieldhouse",
    body: [
      "Zivel Fieldhouse brings modern wellness technology and recovery services to the Fieldhouse community.",
      "Our studio combines cutting-edge technology with personalized care to support recovery, performance, and longevity.",
    ],
    image: "/images/locations/fieldhouse-ms/about.svg",
  },
  ...
  owners: [
    {
      name: "Local Owner",
      bio: "Passionate wellness professional committed to serving the Fieldhouse community with advanced recovery and longevity services.",
    },
  ],
