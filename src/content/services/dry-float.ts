...
export const dryFloat: Service = {
  ...
  intro: {
    headline: "What is Dry Float Therapy?",
    paragraphs: [
  ...
  benefits: {
    ...
    items: [
      ...
      {
        title: "Supports recovery days and soreness routines",
        description:
      ...
      {
        title: "Stacks well with other recovery services",
        description:
  ...
  science: {
    headline: "The Science Behind Floating",
    body: [
  ...
  booking: {
    headline: "Book Your Dry Float Session",
    subheadline:
  ...
  faqs: {
    ...
    items: [
      ...
      {
        question: "Can I stack dry float with other services?",
        answer:
