...
const article: ScienceArticle = {
  slug: "recovery-modalities-float-compression",
  title: "Recovery Modalities: Float Therapy and Compression in Evidence-Informed Practice",
  description:
  ...
  heroImage: {
    src: "/images/science/recovery-modalities.jpg",
    alt: "Float therapy and compression recovery science",
  },

  relatedServiceSlugs: ["dry-float", "compression-therapy"],
  ...
  body: [
    ...
    { type: "h2", content: "Passive recovery: conceptual overview" },
    {
      type: "p",
      content:
    ...
    { type: "h2", content: "Float therapy (dry float): mechanisms and evidence themes" },
    {
      type: "p",
      content:
    ...
    { type: "h2", content: "Stress response and perceived recovery" },
    {
      type: "p",
      content:
    ...
    { type: "h2", content: "Compression therapy: mechanisms and evidence themes" },
    {
      type: "p",
      content:
    ...
    { type: "h2", content: "Comparing float therapy and compression therapy" },
    {
      type: "ul",
      content: [
    ...
    { type: "h2", content: "Safety and practical considerations" },
    {
      type: "p",
      content:
    ...
    { type: "h2", content: "Evidence-informed integration into wellness routines" },
    {
      type: "p",
      content:
