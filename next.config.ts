...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      {
        source: "/riverton",
        destination: "https://zivel.com/locations/utah/riverton",
        permanent: true,
      },
      {
        source: "/riverton/",
      ...
      },
      {
        ...
        destination: "https://zivel.com/locations/mississippi/fieldhouse",
        permanent: true,
      },
      {
        source: "/locations/mississippi/hernando/fieldhouse/",
      ...
      },
      {
        ...
        destination: "https://zivel.com/locations/north-carolina/belmont",
        permanent: true,
      },
      {
        source: "/locations/northcarolina/belmont/",
      ...
      },
      {
        ...
        destination: "https://zivel.com/locations/florida/coral-gables",
        permanent: true,
      },
      {
        source: "/locations/florida/coralgables/",
      ...
      },
      {
        ...
        destination: "https://zivel.com/locations/colorado/highlands-ranch",
        permanent: true,
      },
      {
        source: "/locations/colorado/highlandsranch/",
      ...
      },
      {
        ...
        destination: "https://zivel.com/locations/florida/coral-gables/:path*",
        permanent: true,
      },
      {
        source: "/:path*",
        has: [{ type: "host", value: "brecksville.zivel.com" }],
        destination: "https://zivel.com/locations/ohio/brecksville/:path*",
        permanent: true,
      },
      {
        source: "/locations/georgie/cumming/windermere",
        destination: "https://zivel.com/locations/georgia/windermere",
        permanent: true,
      },
      {
        source: "/locations/georgie/cumming/windermere/",
